...
const Hero = () => {
  ...
  const { isLoading, movieList } = useFetch(
    ...
    <>
      ...
      <section className="drawer drawer-end">
        ...
        <div className="drawer-content">
          <div className="bg-dark flex flex-col-reverse lg:flex-row xs:min-h-screen md:min-h-screen">
            <div className="w-full lg:w-2/5 min-h-fit md:h-screen flex items-center flex-col">
              <p className=" max-sm:text-sm md:text-base text-slate-100 w-full px-4 md:w-[26rem] pt-12 md:pt-32 text-center md:text-left">
                Welcome to Movie tambayan, your ultimate destination for
                discovering the latest and most popular movies. Whether you're a
                fan of action-packed blockbusters, heartwarming dramas, or
                laugh-out-loud comedies, we've got something for everyone. Dive
                in and find your next favorite film today!
              </p>
              ...
              <div className="mt-8 w-full px-4 md:w-auto">
                ...
                <div className="flex flex-wrap justify-center md:justify-start gap-4 mt-4 mb-4">
                  {isLoading ? (
                    // Render Skeleton Loaders when data is still loading
                    Array.from({ length: 3 }).map((_, index) => (
                      <div
                        key={index}
                        className="flex w-24 lg:w-28 xl:w-32 md:h-64 rounded-md flex-col gap-4"
                      >
          ...
          <div className="flex justify-center items-center flex-col gap-2 max-h-80 h-full lg:gap-4 bg-gray-900 px-4 md:px-28 lg:py-4 w-full">
            <p className=" text-gray-200 max-sm:text-sm">
              Discover the latest and greatest in cinema with our movie playlist
              website! Whether you're in the mood for thrilling blockbusters,
              heartwarming dramas, or laugh-out-loud comedies, our curated
              playlists have something for everyone. Dive into handpicked
              collections, explore new genres, and keep track of your favorite
              films all in one place. Your next movie night just got
              easier—start exploring now!
            </p>
          </div>
          ...
          <div className="flex justify-center items-center flex-col gap-2 lg:gap-4 bg-dark px-4 md:px-28 lg:py-4 w-full">
            ...
            <NowPlayingMovie handleClick={handleClick} />
          </div>
          <div className="flex justify-center items-center flex-col gap-2 lg:gap-4 bg-dark px-4 md:px-28 lg:py-12 w-full">
            ...
            <PopularMovie handleClick={handleClick} />
          </div>
          <div className="">
            <MovieCarousel />
          </div>
          <div className="bg-dark xxs:pt-12">
            <MovieCategory handleClick={handleClick} />
          </div>
          <div>
            <Footer />
          </div>
        ...
        <div className="drawer-side z-50">
          ...
          <ul className="menu text-base-content min-h-full w-72 max-xxs:w-60 p-4 bg-dark">
            <div className="collapse collapse-arrow bg-dark">
              ...
              <div className="collapse-title text-xl font-medium text-slate-200">
                Movies
              </div>
